...
<qgis simplifyAlgorithm="0" minScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyDrawingHints="1" readOnly="0" simplifyLocal="1" maxScale="0" labelsEnabled="0" styleCategories="AllStyleCategories" version="3.4.8-Madeira">
  ...
  <labeling type="simple">
    <settings>
      <text-style fontSizeUnit="Point" fontFamily="Raleway Thin" fieldName="LA_Name" isExpression="0" fontSize="8" blendMode="0" fontWeight="25" fontItalic="1" fontWordSpacing="0" fontStrikeout="0" textOpacity="1" textColor="255,255,255,255" fontUnderline="0" useSubstitutions="0" previewBkgrdColor="#ffffff" fontLetterSpacing="0" namedStyle="Italic" fontCapitals="0" fontSizeMapUnitScale="3x:0,0,0,0,0,0" multilineHeight="1">
