...
<qgis simplifyAlgorithm="0" minScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyDrawingHints="1" readOnly="0" simplifyLocal="1" maxScale="0" labelsEnabled="1" styleCategories="AllStyleCategories" version="3.4.8-Madeira">
  <flags>
  ...
  <renderer-v2 preprocessing="0" forceraster="0" enableorderby="0" type="invertedPolygonRenderer">
    <renderer-v2 symbollevels="0" forceraster="0" enableorderby="0" type="RuleRenderer">
      <rules key="{9bb40ff6-63cd-426e-a19e-79b0fb53bb17}">
        <rule filter="NOT $id = @atlas_featureid " key="{f4ae377e-11a3-4901-9dcb-ccb15c421d1c}" symbol="0"/>
      </rules>
      <symbols>
        <symbol force_rhr="0" clip_to_extent="1" name="0" type="fill" alpha="0.638">
          <layer class="SimpleFill" pass="0" locked="0" enabled="1">
            <prop v="3x:0,0,0,0,0,0" k="border_width_map_unit_scale"/>
            <prop v="111,111,111,0" k="color"/>
  ...
  <labeling type="simple">
    <settings>
      <text-style fontSizeUnit="Point" fontFamily="Raleway Light" fieldName="LA_Name" isExpression="0" fontSize="8" blendMode="0" fontWeight="25" fontItalic="0" fontWordSpacing="0" fontStrikeout="0" textOpacity="1" textColor="0,0,0,255" fontUnderline="0" useSubstitutions="0" previewBkgrdColor="#ffffff" fontLetterSpacing="0" namedStyle="Regular" fontCapitals="1" fontSizeMapUnitScale="3x:0,0,0,0,0,0" multilineHeight="1">
        <text-buffer bufferSize="1" bufferSizeUnits="MM" bufferColor="255,255,255,255" bufferJoinStyle="128" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferDraw="0" bufferBlendMode="0" bufferOpacity="1" bufferNoFill="1"/>
